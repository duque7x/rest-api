...
export class BetUser extends BaseUser {
  ...
  remove<F extends keyof BetUserData, A = BetUserData[F]>(field: F, amount: A): Promise<BetUserData>;

  set<F extends keyof BetUserData, A = BetUserData[F]>(key: F, value: A): Promise<BetUserData>;
}
